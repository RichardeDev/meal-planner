...
export default function NotificationsAdminPage() {
  const { notifications, addNotification, removeNotification, markAsRead, markAllAsRead, clearNotifications } =
        ...
        <Card>
          <CardHeader>
            <div className="flex justify-between items-center">
              <div>
                ...
                <CardDescription>Gérez les notifications existantes</CardDescription>
              </div>
          ...
          <CardContent>
            <Tabs defaultValue="all" value={activeTab} onValueChange={setActiveTab}>
                    ...
                    >
                      ...
                      {notification.expiresAt && (
                        <p className="mt-1 text-xs text-muted-foreground">
                          Expire le: {new Date(notification.expiresAt).toLocaleString()}
                        </p>
                      )}
                    </div>
                  ))
              ...
              <TabsContent value="unread" className="space-y-4 max-h-[500px] overflow-y-auto">
                {unreadNotifications.length === 0 ? (
              ...
              <TabsContent value="read" className="space-y-4 max-h-[500px] overflow-y-auto">
