          ...
          <Tabs defaultValue="login" className="w-full">
            ...
            <TabsContent value="info" className="space-y-4">
              <div className="rounded-md bg-slate-100 dark:bg-slate-800 p-4">
                <h3 className="font-medium mb-2">Planificateur de Repas:</h3>
                <div className="space-y-2 text-sm">
                  <p>
                    Cette application est encours de developpement. 
                  </p>
                  <p>
                    Connectez-vous pour accéder à votre planificateur de repas hebdomadaire et planifiez vos repas de la semaine.
                  </p>
                  <p>
                    Veuillez vous inscrire si vous n'avez pas de compte, et obtenez l'accord de l'administrateur pour accéder au planificateur.
                  </p>
                </div>
              </div>
            </TabsContent>
