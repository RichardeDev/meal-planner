...
export async function getWeeklyMealsForWeek(
  weekOffset = 0
): Promise<DayMeals[]> {
...
export async function getUserSelections(
  ...
  const response = await fetch(
    `/api/selections?userId=${userId}&weekOffset=${weekOffset}`
  );
...
export async function getMealSelectionsForDay(
  dayId: string,
  weekOffset = 0
): Promise<UserSelection[]> {
  const response = await fetch(
    `/api/selections?dayId=${dayId}&weekOffset=${weekOffset}`
  );
...
export function isDayEditableForAdmin(
  dateStr: string,
  weekOffset = 0
): boolean {
...
export function getDayAvailabilityMessageForAdmin(
  dateStr: string,
  weekOffset = 0
): string {
...
export function isDayEditable(
  ...
  return isAdmin
    ? isDayEditableForAdmin(dateStr, weekOffset)
    : isDayEditableForUser(dateStr);
}

export function getDayAvailabilityMessage(
  dateStr: string,
  isAdmin = false,
  weekOffset = 0
): string {
  return isAdmin
    ? getDayAvailabilityMessageForAdmin(dateStr, weekOffset)
    : getDayAvailabilityMessageForUser(dateStr);
}
...
export const meals = [
  {
    id: "1",
    name: "Poulet rôti",
    description: "Poulet rôti avec pommes de terre",
  },
  {
    id: "2",
    name: "Spaghetti Bolognaise",
    description: "Pâtes avec sauce tomate et viande hachée",
  },
  {
    id: "3",
    name: "Salade César",
  ...
  { id: "4", name: "Steak-frites", description: "Steak avec frites et salade" },
  {
    id: "5",
    name: "Poisson pané",
    description: "Poisson pané avec riz et légumes",
  },
  {
    id: "6",
    name: "Lasagnes",
    description: "Lasagnes à la viande et béchamel",
  },
  {
    id: "7",
  ...
  },
  {
    id: "10",
    name: "Ratatouille",
    description: "Légumes mijotés à la provençale",
  },
];
